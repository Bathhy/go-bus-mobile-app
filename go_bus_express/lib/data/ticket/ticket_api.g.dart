...
class _TicketApi implements TicketApi {
  ...
  Future<BaseResponse<TicketDetailModel>> getTicketDetail({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<BaseResponse<TicketDetailModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/tickets/${id}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BaseResponse<TicketDetailModel> _value;
    try {
      _value = BaseResponse<TicketDetailModel>.fromJson(
        _result.data!,
        (json) => TicketDetailModel.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
