...
class _PaymentBakongApi implements PaymentBakongApi {
  _PaymentBakongApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<VerifyPaymentModel> verifyMd5({
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body.toJson());
    final _options = _setStreamType<VerifyPaymentModel>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/bakong/verifyMD5',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late VerifyPaymentModel _value;
    try {
      _value = VerifyPaymentModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
